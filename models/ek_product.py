...
class Product(models.Model):
    ...
    def create(self, vals):
        ...
        # 2- CREATE A PRODUCT FROM ODOO (Send a product to ekiclik)
            ...
            rec = super(Product, self).create(vals)
            if "constructor_ref" in vals and vals['constructor_ref'] == "Merci de Générer/entrer une référence constructeur" or rec.constructor_ref == "Merci de Générer/entrer une référence constructeur":
